 ...
 */
export async function isTelemetryAllowed(telemetryConfigFilePath) {
 ...
 */
export function isTelemetryAllowedInEnvironment() {
    const allowed = (!isCi() &&
 ...
 */
async function isTelemetryEnabled(telemetryConfigFilePath) {
    ...
    if (await exists(telemetryConfigFilePath)) {
        ...
        const { enabled } = await readJsonFile(telemetryConfigFilePath);
...
//# sourceMappingURL=telemetry-permissions.js.map