...
export class Anonymizer {
    ...
    filterOutEventsWithExceptionsNotRaisedByHardhat(envelope) {
        /* eslint-disable-next-line @typescript-eslint/consistent-type-assertions --
    ...
    #isErrorMessageAllowed(originalException) {
        ...
        if (exceptionType === "Error" &&
            exceptionMessage.startsWith("require() cannot be used on an ESM graph with top-level await. Use import() instead.")) {
            return false;
        }
        return true;
    }
    #errorRaisedByPackageToIgnore(filename) {
    ...
    #isHardhatFile(filename) {
        ...
        return (filename.includes(nomicFoundationPath) ||
