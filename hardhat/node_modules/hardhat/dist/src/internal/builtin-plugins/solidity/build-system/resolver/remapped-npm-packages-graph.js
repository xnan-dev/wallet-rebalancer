 ...
 */
export function getNormalizeNodeModulesPath(pathToNormalize) {
...
export class RemappedNpmPackagesGraphImplementation {
    ...
    async #readPackageRemappings(npmPackage) {
        const allRemappings = await this.#remappingsReader(npmPackage.name, npmPackage.version, npmPackage.rootFsPath, async (_packageName, _packageVersion, packagePath) => await this.#defaultReadPackageRemappings(packagePath));
