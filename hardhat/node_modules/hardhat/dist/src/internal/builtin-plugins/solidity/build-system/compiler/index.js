 ...
 */
export function hasNativeBuildForPlatform(version, platform) {
...
export async function downloadSolcCompilers(versions, quiet) {
    ...
    if (platform !== CompilerPlatform.WASM) {
        ...
        const nativeVersions = [...versions].filter((v) => hasNativeBuildForPlatform(v, platform));
        if (nativeVersions.length > 0) {
            await mainCompilerDownloader.updateCompilerListIfNeeded(new Set(nativeVersions));
        }
