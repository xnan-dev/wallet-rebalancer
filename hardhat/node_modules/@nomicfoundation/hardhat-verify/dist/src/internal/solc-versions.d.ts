 ...
 */
export declare function resolveSupportedSolcVersions({ compilers, overrides, }: SolidityBuildProfileConfig): string[];
/**
 ...
 */
export declare function filterVersionsByRange(versions: string[], range: string): string[];
//# sourceMappingURL=solc-versions.d.ts.map