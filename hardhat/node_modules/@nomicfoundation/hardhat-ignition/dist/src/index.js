...
const hardhatIgnitionPlugin = {
    ...
    tasks: [
        emptyTask("ignition", "Deploy your smart contracts using Hardhat Ignition").build(),
        ...
        task(["ignition", "deployments"], "List all deployment IDs")
            ...
            .build(),
        task(["ignition", "transactions"], "Show all transactions for a given deployment")
            .addPositionalArgument({
            name: "deploymentId",
            type: ArgumentType.STRING,
        ...
        task(["ignition", "visualize"], "Visualize a module as an HTML report")
            ...
            .build(),
        task(["ignition", "verify"], "Verify contracts from a deployment against the configured block explorers")
            .addPositionalArgument({
            name: "deploymentId",
            type: ArgumentType.STRING,
            ...
            .build(),
        task(["ignition", "track-tx"], "Track a transaction that is missing from a given deployment. Only use if a Hardhat Ignition error message suggests to do so.")
            .addPositionalArgument({
            name: "txHash",
            type: ArgumentType.STRING,
            ...
            .build(),
        task(["ignition", "migrate"], "Migrate artifacts to the new Hardhat 3 format")
            .addPositionalArgument({
            name: "deploymentId",
            type: ArgumentType.STRING,
